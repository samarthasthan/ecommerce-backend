...
page_id = "49e703a951c42877492234b6a8cba9d1"
height = 100
width = 100
...
widget_rank = 0
for widget in homepage:
    widget_rank = widget_rank + 1
    widget_data = {
        "widget_title": widget["widget"]["widget_type"],
        ...
        "items_height": widget["widget"]["items_height"],
        "items_width": widget["widget"]["items_width"],
    }
